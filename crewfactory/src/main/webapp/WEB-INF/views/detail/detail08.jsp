...
<body>
	...
	<div class="mt-5"style="text-align: center;">
		<img src="/img/detail08_001.jpg" alt=지상직취업처" id="mobile-100-percent">
	</div>
	<div class=""style="text-align: center;">
		<img src="/img/detail08_002.jpg" alt=지상직취업처" id="mobile-100-percent">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail08_005.jpg" alt=지상직취업처" id="mobile-100-percent">
	</div>
	<div style="text-align: center;">
		<img src="/img/detail08_006.jpg" alt=지상직취업처" id="mobile-100-percent">
	</div>
	<div class="mobile-hidden text-center" >
		<img src="/img/detail08_007.jpg" alt=지상직취업처"  >
	</div>
	<div style="text-align: center;">
		<img src="/img/detail08_007_mo.jpg" alt=지상직취업처" id="mobile-100-percent" class="mobile-show">
	</div>
